...
#old: J_delta = 1*O_delta/(1 + I/kappa_delta) * C**2/(C**2 + K_delta**2) : mole/second
J_delta = O_delta * (1. -( I/(kappa_delta + I) )) * C**2/(C**2 + K_delta**2) : mole/second

J_3K = O_3K * ( C**4/(C**4 + K_D**4) ) * ( I/(I + K_3K) )               : mole/second  # ERROR? 
...
# Will need to use subgroups to create tiers with individual morpho parameters.
